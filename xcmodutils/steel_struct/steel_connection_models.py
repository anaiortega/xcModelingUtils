...
class BoltArray(object):
    ...
    def getPntHole(self,prep,ind):
        ...
        for i in range(8):
            ...
            pnt=points.newPoint(geom.Pos3d(xbolt+R*math.cos(ang),ybolt+R*math.sin(ang),0))
            lstPnt.append(pnt)
        ...
        for p in range(8):
            ...
            if abs(indIpnt1-indIpnt2)>1:
                ...
                for i in r:
                    ...
                    pntHoleIns=points.newPoint(geom.Pos3d(xbolt+R*math.cos(angPnt),ybolt+R*math.sin(angPnt),0))
